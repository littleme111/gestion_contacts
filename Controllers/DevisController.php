 ...
 *
 */
class devisController extends controllerController {

	public $data;
	public $states;
	public $idsToString;
	public $title = "Demandes de Devis";
	...
	public function __construct($includes){
		...
		//Render the page.
		return $this->render(ABSPATH.'wp-content/plugins/gestion_contacts/Views/devis.tpl.php', array($this->data, $this->title));
	}


	public function styles(){
		$css = array_search('/wp-content/plugins/gestion_contacts/includes/css/mes.css', $this->includes['cssSrcs']);
		$js = array_search('/wp-content/plugins/gestion_contacts/includes/js/devis.js', $this->includes['jsSrcs']);
		...
		$js = array_search('/wp-content/plugins/gestion_contacts/includes/js/tableActionsDevis.js', $this->includes['jsSrcs']);
		wp_enqueue_script($js, $this->includes['jsSrcs'][$js], false );
	}
}

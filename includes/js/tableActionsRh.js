...
jQuery(document).ready(function(){
    $(document).delegate('.Daction select', 'change', function(){
        ...
        if(etat == 'Fermé'){
            ...
            $(document).delegate("#Roui, #Rnon", 'click', function(){
                if($(this).val() == 'Roui'){
					$( "#myTable tr .Did:contains("+id+")" ).closest('tbody tr').find('td:eq(7)').text('En Cours');
                        ...
                        $(document).delegate('#oui, #non', 'click', function(){
                            if($(this).val() == 'oui'){
                                jQuery.ajax({
                                    ...
                                    success:function(){
                                        $( "#myTable tr .Did:contains("+id+")" ).closest('tbody tr').find('td:eq(7)').text('Fermé');
    ...
    $(document).delegate('#btnenvoi', "click", function (e) {
        ...
        $( "#myTable tr .Did:contains("+id+")" ).closest('tbody tr').find('td:eq(7)').text('Transfert');
    ...
    $(document).delegate('#mail_submit', 'click', function(){
        ...
        var id = $('#demId').val();
        $( "#myTable tr .Did:contains("+id+")" ).closest('tbody tr').find('td:eq(7)').text('Répondu');
